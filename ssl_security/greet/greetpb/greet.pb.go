...
var file_greet_greetpb_greet_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x22, 0x3b, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x52, 0x65, 0x71, 0x75, 0x65,
	...
	0x61, 0x73, 0x74, 0x4e, 0x61, 0x6d, 0x65, 0x22, 0x27, 0x0a, 0x0d, 0x47, 0x72, 0x65, 0x65, 0x74,
	0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x12, 0x16, 0x0a, 0x06, 0x72, 0x65, 0x73, 0x75,
	0x6c, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x06, 0x72, 0x65, 0x73, 0x75, 0x6c, 0x74,
	0x32, 0x47, 0x0a, 0x0c, 0x47, 0x72, 0x65, 0x65, 0x74, 0x53, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65,
	0x12, 0x37, 0x0a, 0x0a, 0x55, 0x6e, 0x61, 0x72, 0x79, 0x47, 0x72, 0x65, 0x65, 0x74, 0x12, 0x13,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x42, 0x11, 0x5a, 0x0f, 0x2e, 0x2f, 0x67,
...
var file_greet_greetpb_greet_proto_depIdxs = []int32{
	...
	0, // 1: greet.GreetService.UnaryGreet:input_type -> greet.GreetRequest
	2, // 2: greet.GreetService.UnaryGreet:output_type -> greet.GreetResponse
...
func (c *greetServiceClient) UnaryGreet(ctx context.Context, in *GreetRequest, opts ...grpc.CallOption) (*GreetResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/greet.GreetService/UnaryGreet", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _GreetService_UnaryGreet_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/greet.GreetService/UnaryGreet",
	}
